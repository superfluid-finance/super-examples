...
export interface IConstantOutflowNFTInterface extends utils.Interface {
  functions: {
    ...
    "onCreate(address,address,address)": FunctionFragment;
    "onDelete(address,address,address)": FunctionFragment;
    "onUpdate(address,address,address)": FunctionFragment;
...
export interface IConstantOutflowNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IConstantOutflowNFTInterface;
