...
contract SuperTokenStorageLayoutTester is SuperToken {
    constructor(
        ...
        SuperToken(host) // solhint-disable-next-line no-empty-blocks
    {}
    ...
    function validateStorageLayout() external pure {
        ...
        assembly {
            slot := _underlyingToken.slot
            offset := _underlyingToken.offset
        }
...
contract SuperTokenMock is SuperToken {
    ...
    constructor(ISuperfluid host, uint256 w) SuperToken(host) {
        waterMark = w;
    }
