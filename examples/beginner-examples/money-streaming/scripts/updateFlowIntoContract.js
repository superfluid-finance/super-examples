...
//4) Make sure that you change the params in the updateFlowIntoContract function to reflect the proper values
//3) run: npx hardhat run scripts/updateFlowIntoContract.js --network goerli
async function main() {
    ...
    await moneyRouter
        .connect(signers[0])
        .updateFlowIntoContract(daix.address, "771604938271604")
        .then(function (tx) {
            console.log(`
