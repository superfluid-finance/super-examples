...
import type {
  IConstantInflowNFT,
  IConstantInflowNFTInterface,
} from "../../../../../../@superfluid-finance/ethereum-contracts/contracts/interfaces/superfluid/IConstantInflowNFT";
...
export class IConstantInflowNFT__factory {
  static readonly abi = _abi;
  static createInterface(): IConstantInflowNFTInterface {
    return new utils.Interface(_abi) as IConstantInflowNFTInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IConstantInflowNFT {
    return new Contract(address, _abi, signerOrProvider) as IConstantInflowNFT;
  }
}
