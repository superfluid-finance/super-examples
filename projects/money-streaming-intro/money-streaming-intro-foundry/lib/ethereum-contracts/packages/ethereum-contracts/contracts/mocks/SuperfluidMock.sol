...
contract SuperfluidUpgradabilityTester is Superfluid {
    ...
    function validateContextStructLayout() external pure {
        ...
        // context.agreementSelector
        {
            ...
            require(
                context.agreementSelector == bytes4(uint32(0xdeadbeef)),
                "agreementSelector changed location"
            );
        }
        // context.userData
        {
        ...
        // context.appCreditWantedDeprecated
        {
            ...
            require(
                context.appCreditWantedDeprecated == 42,
                "appCreditWantedDeprecated changed location"
            );
        }
        ...
        // context.appCreditToken
        {
            ...
            require(
                address(context.appCreditToken) == address(42),
                "appCreditToken changed location"
            );
        }
    }
}
