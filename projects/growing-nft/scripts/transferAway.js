...
async function main() {
    ...
    let flower = await hre.ethers.getContractAt(
        flowerABI.abi,
    ...
    if ((await signerFlowerTokenId) == "0") {
        ...
        console.log(
            "The banishAddress provided in this script already has a Flower NFT. Chose another one!"
        )
    } else {
        console.log(
            "Transfering away Flower NFT with Token ID:",
            signerFlowerTokenId
        )
